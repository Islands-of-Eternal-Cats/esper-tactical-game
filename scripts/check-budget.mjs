 ...
 * у них общий свой порог, в начальную загрузку они не входят. Кит юнитов —
 * два скелета с клипами и кот с картой (~175 КБ), оружие из частей — ~65.
 */
const LIMIT_UNIT_KB = 260
